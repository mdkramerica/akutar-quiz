  ...
  return (
    <main className="min-h-screen bg-akuverse p-4 overflow-x-hidden pb-safe">
      ...
      <div className="relative z-10 max-w-3xl mx-auto pt-6 sm:pt-10">
        ...
        {/* TRAITS */}
        <div className="glass border border-cyan-500/20 border-glow-cyan rounded-sm p-5 sm:p-8 mb-6 sm:mb-8">
        ...
        {/* ASTRONAUTS */}
        <div className="glass border border-white/10 rounded-sm p-5 sm:p-8 mb-6 sm:mb-8" style={{background: 'rgba(30, 10, 60, 0.4)'}}>
        ...
        {/* MISSION */}
        <div className="glass-dark border border-cyan-400/20 border-glow-cyan rounded-sm p-6 sm:p-10 mb-8 sm:mb-10 text-center">
